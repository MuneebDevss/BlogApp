...
import 'package:blog_app_vs/feature/auth/Presentation/Pages/signUp_page.dart';
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            context.read<AuthBloc>().add(BlocLogin(
                        ...
                        child: const Text(
                          "Sign In",
                          style:
                              TextStyle(color: AppPallete.White, fontSize: 20),
                        ),
                      ),
                    ),
                    const SizedBox(
